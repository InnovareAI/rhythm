...
<head>
  ...
  <style>
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .headline { font-weight: 800; font-size: 24px; line-height: 1.2; letter-spacing: 0.02em; margin-bottom: 10px; }
    .subcopy { font-size: 13px; line-height: 1.4; max-width: 90%; opacity: 0.9; }
    ...
    <div class="isi-section">
      ...
      <div class="isi-scroll-wrapper">
        <div class="isi-scroll-content">
          <strong>Indication:</strong> IMCIVREE is indicated to reduce excess body weight and maintain weight reduction long term in adults and pediatric patients aged 2 years and older with obesity due to Bardet-Biedl syndrome (BBS). <strong>Limitations of Use:</strong> IMCIVREE is not indicated for other types of obesity not related to BBS. <strong>Contraindications:</strong> Prior serious hypersensitivity to setmelanotide or any excipients in IMCIVREE. Serious hypersensitivity reactions (e.g., anaphylaxis) have been reported. <strong>Warnings and Precautions:</strong> Disturbance in sexual arousal: Spontaneous penile erections in males and sexual adverse reactions in females have occurred. Depression and suicidal ideation have been reported. Skin hyperpigmentation and darkening of pre-existing nevi may occur. Risk of serious adverse reactions due to benzyl alcohol preservative in neonates and infants. <strong>Adverse Reactions:</strong> Most common (≥20%): skin hyperpigmentation, injection site reactions, nausea, headache, diarrhea, abdominal pain, vomiting, depression, spontaneous penile erection. <strong>Use in Specific Populations:</strong> Treatment with IMCIVREE is not recommended when breastfeeding. Discontinue IMCIVREE when pregnancy is recognized unless benefits outweigh risks. Please see full Prescribing Information.
        </div>
      </div>
    </div>
  </div>
