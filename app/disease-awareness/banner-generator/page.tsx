...
- Cinemagraph video background on Frame 1
- Single claim with proper reference on Frame 2
- Magenta CTA button + micro-reference footer on Frame 3
- Retail-minimal aesthetic (Everlane/Casper style)
...
Give me a moment...`
  ...
  const startOver = () => {
    ...
    setStreamingContent('')
    // Keep the bannerStyle so user doesn't have to re-select
  }
    ...
    return (
      <div className="min-h-screen bg-gradient-to-b from-[#f9f2f8] via-white to-[#f9f2f8]">
        ...
        <main className="mx-auto max-w-4xl px-6 py-12">
          ...
          <p className="text-center text-[#4a4f55] mb-8">
